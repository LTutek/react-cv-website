          ...
          <div className="travel row">
            <div className="col-xl-12 col-md-6 description margin-bottom-3">
              <sdx-card label="Travel" label-aria-level="2">
                ...
                entdecken. Das Reisen erweitert meinen Horizont, bereichert mein
                Leben und schenkt mir kostbare Erinnerungen, die mich ein Leben
                lang begleiten.
              </sdx-card>
            </div>
          ...
          <sdx-tabs-item label="Friends" icon-name="icon-crowd">
            <div className="col-xl-12 col-md-6 description offset-md-3">
              <sdx-card label="Friends" label-aria-level="2">
                ...
                gemeinsam Zeit zu verbringen und schöne Momente zu erleben. Wir
                unternehmen verschiedene Aktivitäten zusammen, wie zum Beispiel
                Ausflüge in die Natur oder gemeinsam in Restaurants essen. Es
                ist eine Zeit, in der wir uns gegenseitig unterstützen, uns
                austauschen und einfach Spass haben können. Diese Momente
                stärken unsere Freundschaft und sind wichtige Erholungsphasen
          ...
          <sdx-tabs-item label="Reading" icon-name="icon-book">
            <div className="col-xl-12 col-md-6 description offset-md-3">
              <sdx-card label="Reading" label-aria-level="2">
                Ich lese nicht so oft, wie ich es gerne hätte. Jedoch ist diese
                Aktivität für mich eine Möglichkeit, von digitalen Medien
                wegzukommen und in eine andere Welt einzutauchen.
              </sdx-card>
            </div>
          </sdx-tabs-item>
        </div>
