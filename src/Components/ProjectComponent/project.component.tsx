            ...
            <sdx-content-slider lg={2} xl={2} ul={2} sr-hint="My projects">
              ...
              >
                ...
                <div className="description-container">
                  ...
                  <p>
                    In meinen ersten beiden Wochen bei Swisscom verbrachte ich
                    Zeit in den ersten Schritten von Team 31 und Team 14. Dort
                    erhielt ich eine Einführung in die grundlegenden Abläufe und
              ...
              >
                ...
                <div className="description-container">
                  ...
                  <p>
                    ...
                    grundlegenden Technologien und Fähigkeiten, die mir den Weg
                    als Applikationsentwickler ebneten.
                  </p>
                  <p>
              ...
              >
                ...
                <div className="description-container">
                  ...
                  <p>
                    ...
                    Applikation Newsroom. Dazu teile ich die Rolle als Product
                    Owner mit Sabira Shanmugalingam. Durch diese Erfahrung habe
                    ich gelernt in einem Team agil zu arbeiten und dieses zu
                    führen.
                  </p>
                  <p>
              ...
              >
                ...
                <div className="description-container">
                  ...
                  <p>
                    Im Apps-Team erwarb ich fundierte Kenntnisse im
                    Backend-Bereich. Nach meinem Einstieg in NestJs und
                    TypeScript war ich schon bald in der Lage, aktiv an der
